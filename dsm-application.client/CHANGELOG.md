...
- Create Angular project with ng: `ng new dsm-application.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`dsm-application.client.esproj`).
